...
public class QuestComboKillBySpecialGun : BaseQuest
{
	...
	{
		this.keyDescription = "combo_kill_by_special_gun";
		base.Init();
		EventDispatcher.Instance.RegisterListener(EventID.GetComboKillBySpecialGun, delegate(Component sender, object param)
		{
