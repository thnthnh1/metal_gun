...
public class StoneBossMonkey : BaseBullet
{
	...
	public override void Deactive()
	{
		...
		Singleton<PoolingController>.Instance.poolStoneBossMonkey.Store(this);
	}

	protected override void SpawnHitEffect()
	{
		EffectController.Instance.SpawnParticleEffect(EffectObjectName.StoneBrokenMedium, base.transform.position);
