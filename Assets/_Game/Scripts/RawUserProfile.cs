...
public class RawUserProfile
{
	...
	public string playerCampaignProgessData;

	public string playerCampaignStageProgessData;
	...
	public bool isClaimNewbiePack;

	public bool isClaimHeroPack;
	...
	public string strTimestampNextFreeGifts;
}
