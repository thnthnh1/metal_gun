...
public class StaticValue
{
	...
	public const int PRICE_STARTER_PACK_BY_GEM = 500;
	...
	public const string PATH_JSON_NEW_PLAYER_CAMPAIGN_PROGRESS_DATA = "JSON/New Player Data/new_player_campaign_progress_data";

	public const string PATH_JSON_NEW_PLAYER_CAMPAIGN_STAGE_PROGRESS_DATA = "JSON/New Player Data/new_player_campaign_stage_progress_data";
...
#if UNITY_IOS
	public static string storeUrl = "https://apps.apple.com/app/id6459527517?action=write-review";
#else
	public static string storeUrl = "https://play.google.com/store/apps/details?id=com.titan.Metalgun";
#endif
}
