...
public class SurvivalResultData
{
	...
	public SurvivalResultData(int numberWave, int soldierKill, int soldierScore, int vehicleKill, int vehicleScore, int bossKill, int bossScore, int timeScore, int highestComboKill, int totalScore)
	{
