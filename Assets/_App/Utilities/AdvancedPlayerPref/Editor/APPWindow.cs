...
namespace RejectedGames
{
	public class APPWindow : EditorWindow
	{
		...
		private GUIStyle ToolbarSeachTextFieldPopup { get { return GetStyle("ToolbarSearchTextFieldPopup"); } }
		private GUIStyle ToolbarSeachCancelButton { get { return GetStyle("ToolbarSearchCancelButton"); } }
